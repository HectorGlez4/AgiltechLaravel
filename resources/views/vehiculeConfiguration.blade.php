...
@section('content')
	<div class="container">
		<h1>Vehicule Configuration <small> ID: {{{$vehicule->VHC_ID}}} </small> </h1>
		...
		<div class="btn-group btn-group-justified" role="group" ">
			<div class="btn-group"><a href="#" class="btn btn-lg btn-default btn-grp">Return</a></div>
			<div class="btn-group"><a href="interventionManagement.php" class="btn btn-lg btn-primary btn-grp">New Textual Task</a></div>
		</div>
	</div>
@stop